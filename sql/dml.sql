...
VALUES(N'Алгоритмы поиска', 1, NULL, 1)
	 ,(N'Алгоритмы сортировки', 1, NULL, 2)
	 ,(N'Алгоритмы для работы с графами', 1, NULL, 3)
	 ,(N'Два указателя', 0, NULL, 4)
...
INSERT INTO Topics([Name], HasChildren, ParentId, [Order])
VALUES(N'Линейный поиск', 0, 1, 1)
	 ,(N'Бинарный поиск', 0, 1, 2)
	 ,(N'Cортировка пузырьком', 0, 2, 1)
	 ,(N'Cортировка выбором', 0, 2, 2)
	 ,(N'Быстрая сортировка', 0, 2, 3)
	 ,(N'BFS (breadth first search)', 0, 3, 1)
	 ,(N'DFS (depth first search)', 0, 3, 2)
	 ,(N'Алгоритм Дейкстры', 0, 3, 3)
	 ,(N'Алгоритм Хаффмана', 0, 5, 1)
	 ,(N'Алгоритм Краскала', 0, 5, 2)
