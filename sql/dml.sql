...
VALUES('Алгоритм поиска', 1, NULL, 1)
	 ,('Алгоритм сортировки', 1, NULL, 2)
	 ,('Алгоритмы для работы с графами', 1, NULL, 3)
	 ,('Два указателя', 0, NULL, 4)
	 ,('Жадные алгоритмы', 1, NULL, 5)
	 ,('Быстрое возведение в степень C#', 1, NULL, 6)

GO

INSERT INTO Topics([Name], HasChildren, ParentId, [Order])
VALUES('Линейный поиск', 0, 1, 1)
	 ,('Бинарный поиск', 0, 1, 2)
	 ,('Cортировка пузырьком', 0, 2, 1)
	 ,('Cортировка выбором', 0, 2, 2)
	 ,('Быстрая сортировка', 0, 2, 3)
	 ,('BFS (breadth first search)', 0, 3, 1)
	 ,('DFS (depth first search)', 0, 3, 2)
	 ,('Алгоритм Дейкстры', 0, 3, 3)
	 ,('Алгоритм Хаффмана', 0, 5, 1)
	 ,('Алгоритм Краскала', 0, 5, 2)
	 ,('Рекурсивная реализация быстрого возведения в степень', 0, 6, 1)
	 ,('Итерационная реализация быстрого возведения в степень', 0, 6, 2)
...
VALUES(7, 6, N'', NULL, 6, 1)
	 ...
	 ,(15, 5, N'Дарахти бинарӣ сохта мешавад, ки дар он ҳар як барг рамз аст ва гиреҳҳои дохилӣ ҷамъи басомади наслҳои худ мебошанд;'+char(10)+'Дар ҳар қадам алгоритм ду гиреҳро бо басомади камтарин муттаҳид мекунад ва гиреҳи навро бо басомади умумӣ эҷод мекунад.', NULL, 6, NULL)
	 ,(15, 2, N'3. Таъини рамзҳо:', NULL, 7, NULL)
	 ,(15, 5, N'Рамзи префиксӣ (пайдарпаии битӣ) барои ҳар як рамз аз рӯи дарахт аз реша ба баргҳо сохта мешавад. Дар зери дарахти чап "0" ва дар тарафи рост "1" нишон дода шудааст;'+char(10)+'Ба шарофати усули чашмгуруснагии сохтани дарахт, рамзҳои дарозии тағйиребанда аксар вақт истифода мешаванд. Аксар вақт рамзҳои кӯтоҳтар ба рамзҳои бештар таъин карда мешаванд.', NULL, 8, NULL)
	 ,(15, 2, N'4. Фишурдани маълумот:', NULL, 9, NULL)
	 ,(15, 5, N'Паем (е файл) бо версияи фишурда иваз карда мешавад, ки дар он ҳар як рамз бо рамзи префиксии мувофиқ иваз карда мешавад;'+char(10)+'Ин ба шумо имкон медиҳад, ки маълумотро бо истифода аз битҳои камтар пешниҳод кунед, агар рамзҳои зуд-зуд рамзҳои кӯтоҳтар дошта бошанд.', NULL, 10, NULL)
	 ,(15, 6, N'', NULL, 11, 3)
	 ...
	 ,(8, 5, N'Миенаи массивро ҳисоб мекунем: mid = (left + right) / / 2;'+char(10)+'Агар арзиш дар мавқеи mid ба арзиши дилхоҳ баробар бошад, мо mid-ро бармегардонем;'+char(10)+'Агар арзиши мавқеи mid аз он чизе, ки мо меҷӯем, зиедтар бошад, мо right - ро дар mid-1 навсозӣ мекунем;'+char(10)+'Агар арзиши мавқеи mid аз он чизе, ки мо меҷӯем, камтар бошад, мо left-ро дар mid + 1 навсозӣ мекунем.', NULL, 5, NULL)
