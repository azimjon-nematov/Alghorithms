...
(function (j, b, d) {
    ...
    var f = MathJax.Object.Subclass({
        ...
        testCollection: function (n) {
            ...
            m.family = {
                TeX: "MathJax_Size1",
                STIX: "STIXSizeOneSym"
            }[n] || n.replace(/-(Math)?/, "") + "MathJax_Size1";
            if (n === "STIX") {
                m.noStyleChar = true
            }
    ...
    d.Augment({
        ...
        Startup: function () {
            ...
            this.linebreakSpan = MathJax.HTML.Element("span", {
        ...
        preTranslate: function (s) {
            var r = s.jax[this.id], D, z = r.length, y, G, w, C, u, E, p, F, o, H, v, t = false, A, q = this.config.linebreaks.automatic, x = this.config.linebreaks.width;
            if (q) {
        ...
        initFont: function (m) {
            ...
            return j.Styles({
                "@font-face": this.Font.fontFace(m)
            })
        },
        Remove: function (m) {
            ...
            if (E) {
                ...
                if (!this.msieClipRectBug && !E.noclip && !p) {
                    ...
                    var F = z - B - C
                        ...
                        , o = -1000
                        , m = E.rw + 1000;
                    v.style.clip = "rect(" + this.Em(F) + " " + this.Em(m) + " " + this.Em(q) + " " + this.Em(o) + ")"
                }
            }
        ...
        checkFont: function (m, n) {
            ...
            return (m.family.replace(/'/g, "") === n.fontFamily.replace(/'/g, "") && (m.style || "normal") === (n.fontStyle || "normal") && (m.weight || "normal") === o)
        },
        ...
        i.mbase.Augment({
            ...
            HTMLcreateSpan: function (m) {
                ...
                if (this.style) {
                    ...
                    this.styles = {
                        border: d.getBorders(m),
                        padding: d.getPadding(m)
                    };
        ...
        i.mpadded.Augment({
            toHTML: function (u, o, m) {
                ...
                if (this.data[0] != null) {
                    ...
                    var v = this.getValues("height", "depth", "width", "lspace", "voffset")
                        , t = 0
                        , r = 0
                        , w = this.HTMLgetMu(u);
                    this.HTMLgetScale();
    ...
    b.Register.StartupHook("End Config", function () {
        b.Browser.Select({
            ...
            Safari: function (r) {
                ...
                if (m) {
                    d.Augment({
                        webFontDefault: (r.isMobile ? "sans-serif" : "serif")
                    })
                }
                if (r.isPC) {
                    d.Augment({
